  ...
  return (
    <footer className="border-t border-white/5 bg-[radial-gradient(circle_at_100%_0%,rgba(31,123,127,0.18),transparent_0_24%),linear-gradient(180deg,#1a2524_0%,#121919_100%)] px-5 py-8 text-white/80 md:px-8 2xl:px-[60px]">
      <div className="grid gap-8 xl:grid-cols-[1.2fr_1fr_1fr]">
        <div>
          <p className="font-display text-[1.8rem] leading-none tracking-[-0.03em] text-white/95">{siteConfig.name}</p>
          <p className="mt-2 text-[0.84rem] uppercase tracking-[0.12em] text-white/55">{siteConfig.descriptor}</p>
          <p className="mt-3 max-w-[36ch] text-sm leading-7 text-white/72">
        ...
        <div>
          <p className="inline-flex items-center gap-3 text-[0.74rem] font-extrabold uppercase tracking-[0.18em] text-white/75 before:h-px before:w-8 before:bg-[linear-gradient(90deg,rgba(255,255,255,0.82),rgba(255,255,255,0.2))] before:content-['']">
            Mapa do site
          </p>
        ...
        <div>
          ...
          <ul className="mt-4 grid gap-4 text-sm leading-7">
            <li>
              <span className="block text-[0.72rem] uppercase tracking-[0.12em] text-white/45">Instagram</span>
            ...
            <li>
              <span className="block text-[0.72rem] uppercase tracking-[0.12em] text-white/45">Local</span>
              <strong className="font-semibold text-white/88">Centro • Canaã dos Carajás • PA</strong>
            </li>
            <li>
              <span className="block text-[0.72rem] uppercase tracking-[0.12em] text-white/45">Agenda</span>
      ...
      <div className="mt-8 flex flex-col gap-3 border-t border-white/8 pt-5 text-sm text-white/55 md:flex-row md:items-center md:justify-between">
